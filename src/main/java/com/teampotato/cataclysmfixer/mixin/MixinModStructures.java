package com.teampotato.cataclysmfixer.mixin;
...
import static com.teampotato.cataclysmfixer.CataclysmFixer.*;
...
public abstract class MixinModStructures {
    ...
    /**
     * @author Kasuliax
     * @reason Allow structures generation config settings
     */
    @Overwrite
